...
freqterms<- findFreqTerms(unigram, lowfreq = 75)
terms <- rowSums(as.matrix(unigram[freqterms,]))
terms <- data.frame(unigram=names(terms), frequency=terms)
```
...
freqterms<- findFreqTerms(bigram, lowfreq = 75)
terms <- rowSums(as.matrix(bigram[freqterms,]))
terms <- data.frame(bigram=names(terms), frequency=terms)
```
...
terms <- rowSums(as.matrix(trigram[freqterms,]))
terms <- data.frame(trigram=names(terms), frequency=terms)
```
